<?php
	...
	$pages = array(
		...
		'1'	=> array('id' => '2', 'alias' => 'Contributors', 'file' => '2.php','controllers' => array()),
		'2'	=> array('id' => '3', 'alias' => 'FAQ', 'file' => '3.php','controllers' => array())
	);
	$forms = array(
	...
	$base_lang = 'en';
	$site_id = "d04f0199";
	$websiteUID = "63abdebd31e682afaaf4e5ea709805f05466c5754ec49101380018650b2c8a02bf744d1b7ba8bc62";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'packpng.com';
	$home_page = '1';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "https://sitebuilder1.web-hosting.com:443/comment_callback/";
	$user_key = "iDyNVrV14EwNb3c=";
	$user_hash = "c348e548776930dc";
